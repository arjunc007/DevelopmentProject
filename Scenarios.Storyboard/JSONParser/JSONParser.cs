...
namespace API
{
    public static class JSONParser
    {
        ...
        {
            json = JsonConvert.SerializeObject(tObject, Formatting.None, new JsonSerializerSettings { ContractResolver = new MyContractResolver(), PreserveReferencesHandling = PreserveReferencesHandling.All, ReferenceLoopHandling = ReferenceLoopHandling.Serialize });
        }
